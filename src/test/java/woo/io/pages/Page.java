...
/**
 * Abstract class representation of a woo.io.Page in the UI. woo.io.Page object pattern
 */
...
//  Assert.assertEquals(getTitle(), getPageTitle());
    ...
    public static void setElementTextAndEnter(WebElement element, String text) {
        element.click();
        element.clear();
        //Log.info("entering text '" + text + "' into element " + element);
        element.sendKeys(text);
